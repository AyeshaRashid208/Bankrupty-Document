...
class Chapter7FormController extends Controller
{
    ...
    {
        $part1 = Part1::where('user_id',Auth()->user()->id)->get();
        // dd(Auth()->user()->id);
        return view('client.chapter7-form.index',compact('part1'));
    }
    public function create()
    {
        return view('client.chapter7-form.create');
    }
    ...
    public function edit($id)
    {
        ...
        $part6 = Part6::where('petition_id',$id)->first();
        $part7 = Part7::where('petition_id',$id)->first();
        return view('client.chapter7-form.edit',compact('part1','part1_b','part2','part3','part4','part5','part6','part7'));
    }
