...
class QuestionaireController extends Controller
{
    ...
    {
        $questionaire = Questionaire::where('user_id',Auth()->user()->id)->get();
        return view('client.questionaire.index',compact('questionaire'));
    }
    ...
    {
        return view('client.questionaire.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $q->save();
            return redirect('questionaire')->with('success','Bankruptcy Quetionaire has created!');
        }catch(Exception $e){
    ...
    public function show($id)
    {
        ...
        return view('client.questionaire.show',compact('q'));
    }
