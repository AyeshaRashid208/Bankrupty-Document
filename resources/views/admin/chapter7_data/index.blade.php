...
<div class="content-body">
    ...
    @can('chapter7_data_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.chapter7_data.create') }}">
                    Add New
                </a>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover datatable datatable-User"  id="table-1">
                    ...
                    <tbody>
                        @foreach ($chapter7_data as $index=> $item)
                            <tr>
                                <td>
                                    {{ $index+1 }}
                                </td>
                                ...
                                <td>
                                    @can('chapter7_data_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.chapter7_data.edit', $item->id) }}">
                                            Edit
                                        </a>
                                    @endcan
                                    @can('chapter7_data_delete')
