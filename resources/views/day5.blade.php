            ...
            <div class="d-table-cell">
                <div class="container">
                    <div class="title-content">
                        <h2>Introduction to 5-7 Days Processing Time</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-10 mx-auto">
                    <div class="loan-item ">
                        <div class="loan-img mt-4">
                            <h2 class="text-center">HOW 5-7 Days Processing Time</h2>

                        </div>
                        <ul>
                            @foreach ($day5 as $item)
                            <li>
                                <h3>
                    ...
                    <div class="details-client my-4">
                        <h2>{{$data['#day5_bottom']['heading']??''}}</h2>
                        {!!$data['#day5_bottom']['description']??''!!}
