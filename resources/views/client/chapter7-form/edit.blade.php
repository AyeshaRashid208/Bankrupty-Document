            ...
            <div class="cointainer-fluid">
                ...
                <div class="user-form-area chapter-form ptb-100">
                    <div class="container pt-4">
                        <form action="{{ route('client.chapter7-form.update',$part1->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control inputs" name="case_no"
                            ...
                            <div class="col-12 col-md-4 my-select">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="chapter"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <h5 class="d-block d-md-none">About Debtor</h5>
                                <div class="form-group">
                                    <input type="text" class="form-control inputs" name="ssn1"
                                        value="{{ $part1->ssn1 ?? '' }}" placeholder="">
                                </div>
                                <h6 class="text-center my-2">OR</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control inputs" name="itin1"
                            ...
                            <div class="col-12 col-md-4">
                                <h5 class="d-block d-md-none">About Debtor 2 (Spouse Only in a Joint Case)</h5>
                                <div class="form-group">
                                    <input type="text" class="form-control inputs" name="ssn2"
                                        value="{{ $part1->ssn2 ?? '' }}" placeholder="">
                                </div>
                                <h6 class="text-center my-2">OR</h6>
                                <div class="form-group">
                                    <input type="text" class="form-control inputs" name="itin2"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="form-group">
                                    <label>EIN</label>
                                    <input type="text" class="form-control inputs" name="ein1"
                                        value="{{ $part1_b->ein1 ?? '' }}" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label>EIN </label>
                                    <input type="text" class="form-control inputs" name="ein2"
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="form-group">
                                    <label>EIN</label>
                                    <input type="text" class="form-control inputs" name="ein3"
                                        value="{{ $part1_b->ein3 ?? '' }}" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label>EIN </label>
                                    <input type="text" class="form-control inputs" name="ein4"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="form-group">
                                    <label>County</label>
                                    <input type="text" class="form-control inputs" name="country1"
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="form-group">
                                    <label>County</label>
                                    <input type="text" class="form-control inputs" name="country2"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <h5 class="d-block d-md-none">About Debtor</h5>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="distric_type1"
                            ...
                            <div class="col-12 col-md-4">
                                <h5 class="d-block d-md-none">About Debtor 2 (Spouse Only in a Joint Case)</h5>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="distric_type2"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                <label> Check one. (For a brief description of each, see Notice Required by 11 U.S.C. § 342(b)
                                    ...
                                    box.</label>
                                <div class="form-check ">
                                    <input class="form-check-input" type="radio" name="bankruptcy"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="bankruptcy_8year"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="credit_couseling1"
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="credit_couseling2"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <div class="form-check mt-3">
                                    <input class="form-check-input" type="radio" name="consumer_debts"
                                ...
                                <div class="form-check mt-3">
                                    <input class="form-check-input" type="radio" name="business_debts"
                                ...
                                <div class="form-group">
                                    <label>16c. State the type of debts you owe that are not consumer debts or business
                                        debts</label>
                                    <input type="text" class="form-control" name="debit_type"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <div class="form-check mt-3">
                                    <input class="form-check-input" type="radio" name="under_chapter7"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="long_term"
