...
<div class="content-body">
    <div class="dashboard-sec">
        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('client.chapter13.create') }}">
                    Add New
                </a>
            </div>
        </div>
                        ...
                        @foreach ($team as $index=> $item)
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-xs btn-info" href="{{ route('client.chapter13.show', $item->id) }}">
                                            View
                                        </a>
                                        <a class="btn btn-xs btn-warning" href="{{ route('client.chapter13.edit', $item->id) }}">
                                            Edit
                                        </a>
...
<script>
    function teamDelete{{$item->id}}(id){
        swal({
            ...
            if (willDelete) {
                var url = '{{ route("client.deleteChapter13", ":id") }}';
