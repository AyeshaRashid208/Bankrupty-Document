            ...
            <nav class="navbar navbar-expand-lg header-nav">
                ...
                <div class="main-menu-wrapper">
                    ...
                    <ul class="main-nav">
                        ...
                        <li>
                            <a href="{{ url('/home') }}" target="_blank">Admin</a>
                        </li>
                    </ul>
                </div>
                <ul class="nav header-navbar-rht">
                    ...
                    <li class="nav-item dropdown has-arrow main-drop account-item">
                        ...
                        <div class="dropdown-menu emp">
                            ...
                            <a class="dropdown-item" href="{{url('profile')}}"><i class="material-icons">verified_user</i> View
                                profile</a>
                            <div class="drop-head">Projects Settings</div>
                            <a class="dropdown-item" href="#"><i class="material-icons">business_center</i>
                                Projects</a>
                        ...
                        <div class="settings-widget">
                            <div
                                ...
                                <a href="#"><img alt="profile image"
                                        src="{{ asset(Auth()->user()->image ?? 'assets/img/img-04.jpg') }}"
