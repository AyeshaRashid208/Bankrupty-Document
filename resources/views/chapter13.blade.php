            ...
            <div class="d-table-cell">
                <div class="container">
                    <div class="title-content">
                        <h2>Introduction to Chapter 13 Bankruptcy</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class=" col-12 col-md-9 mx-auto ">
                    <div class="widget-area bg-light">
                        <div class="services widget-item">
                            {!!$data['#chapter13_detail']['description']??''!!}
                ...
                <div class="col-12 col-md-10 mx-auto">
                    <div class="loan-item ">
                        <div class="loan-img mt-4">
                            <h2 class="text-center">HOW CHAPTER 13 BANKRUPTCY AFFECTS YOU</h2>
                        </div>
                        <ul>
                            @foreach ($chapter13 as $item)
                            <li>
                                <h3>
                            ...
                            <li>
                                ...
                                <p>You may retain up to $23,6135 of equity in homes, mobile homes, coops, or burial plots.
                            ...
                            <li>
                                ...
                                <p>If the equity in your home is less than $23,6135, your court-appointed bankruptcy trustee
                    ...
                    <div class="details-client my-4">
                        <h2>{{$data['#chapter13_bottom']['heading']??''}}</h2>
                        {!!$data['#chapter13_bottom']['description']??''!!}
