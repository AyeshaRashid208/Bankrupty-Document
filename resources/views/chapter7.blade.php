            ...
            <div class="d-table-cell">
                <div class="container">
                    <div class="title-content">
                        <h2>Introduction to Chapter 7 Bankruptcy</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class=" col-12 col-md-9 mx-auto ">
                    <div class="widget-area bg-light">
                        <div class="services widget-item">
                            {!!$data['#chapter7_detail']['description']??''!!}
                ...
                <div class="col-12 col-md-10 mx-auto">
                    <div class="loan-item ">
                        <div class="loan-img mt-4">
                            <h2 class="text-center">HOW CHAPTER 7 BANKRUPTCY AFFECTS YOU</h2>

                        </div>
                        <ul>
                            @foreach ($chapter7 as $item)
                            <li>
                                <h3>
                    ...
                    <div class="details-client my-4">
                        <h2>{{$data['#chapter7_bottom']['heading']??''}}</h2>
                        {!!$data['#chapter7_bottom']['description']??''!!}
